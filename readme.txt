...
3. Open the plugin settings page, under Settings -> Yahoo! Updates Plugin and follow the directions to create an API key for the plug-in.
4. After saving the new application settings, authorize the plug-in to access your Yahoo! account. 
5. All set! Anytime you publish a new blog post an update will be sent.

== Changelog ==

= 1.0.1 =
* Fixed new updates being sent when a blog post is updated
* Updated author email addresses
* Updated .ico file note
